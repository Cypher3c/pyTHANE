...
#
# Created: Mon Jul 11 15:46:22 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 261, 611))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(300, 60, 101, 41))
        ...
        sizePolicy.setHeightForWidth(self.virtualCheck.sizePolicy().hasHeightForWidth())
        self.virtualCheck.setSizePolicy(sizePolicy)
        self.virtualCheck.setMouseTracking(False)
        self.virtualCheck.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.virtualCheck.setAutoFillBackground(False)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(290, 180, 251, 191))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(290, 390, 251, 181))
        ...
        self.saveButton.setGeometry(QtCore.QRect(360, 600, 106, 27))
        self.saveButton.setObjectName("saveButton")
        self.pushButton = QtGui.QPushButton(self.centralwidget)
        self.pushButton.setEnabled(False)
        self.pushButton.setGeometry(QtCore.QRect(610, 200, 131, 27))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_2.setEnabled(False)
        self.pushButton_2.setGeometry(QtCore.QRect(610, 230, 131, 27))
        self.pushButton_2.setObjectName("pushButton_2")
        self.gridLayoutWidget_2 = QtGui.QWidget(self.centralwidget)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(420, 50, 91, 51))
        ...
        self.classBox = QtGui.QLineEdit(self.gridLayoutWidget_2)
        self.classBox.setMaxLength(1)
        self.classBox.setObjectName("classBox")
        self.gridLayout_2.addWidget(self.classBox, 0, 1, 1, 1)
        self.gridLayoutWidget_3 = QtGui.QWidget(self.centralwidget)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(295, 110, 241, 51))
        ...
        self.populationBox = QtGui.QLineEdit(self.gridLayoutWidget_3)
        self.populationBox.setMaxLength(30)
        ...
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(560, 540, 221, 51))
        self.gridLayoutWidget_5.setObjectName("gridLayoutWidget_5")
        self.gridLayout_5 = QtGui.QGridLayout(self.gridLayoutWidget_5)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.spaceCombo = QtGui.QComboBox(self.gridLayoutWidget_5)
        self.spaceCombo.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spaceCombo.sizePolicy().hasHeightForWidth())
        self.spaceCombo.setSizePolicy(sizePolicy)
        self.spaceCombo.setObjectName("spaceCombo")
        self.gridLayout_5.addWidget(self.spaceCombo, 0, 2, 1, 1)
        ...
        self.gfxLabel.setGeometry(QtCore.QRect(570, 300, 220, 220))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gfxLabel.sizePolicy().hasHeightForWidth())
        self.gfxLabel.setSizePolicy(sizePolicy)
        self.gfxLabel.setFrameShape(QtGui.QFrame.Box)
        self.gfxLabel.setText("")
        self.gfxLabel.setObjectName("gfxLabel")
        self.gridLayoutWidget_6 = QtGui.QWidget(self.centralwidget)
        self.gridLayoutWidget_6.setGeometry(QtCore.QRect(560, 590, 221, 51))
        self.gridLayoutWidget_6.setObjectName("gridLayoutWidget_6")
        self.gridLayout_6 = QtGui.QGridLayout(self.gridLayoutWidget_6)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.exteriorCombo = QtGui.QComboBox(self.gridLayoutWidget_6)
        self.exteriorCombo.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.exteriorCombo.sizePolicy().hasHeightForWidth())
        self.exteriorCombo.setSizePolicy(sizePolicy)
        self.exteriorCombo.setObjectName("exteriorCombo")
        self.gridLayout_6.addWidget(self.exteriorCombo, 0, 2, 1, 1)
        ...
        self.actionSet_Naev_Directory.setEnabled(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QtGui.QApplication.translate("MainWindow", "Commodities...", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_2.setText(QtGui.QApplication.translate("MainWindow", "Tech...", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("MainWindow", "Class:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MainWindow", "Population:", None, QtGui.QApplication.UnicodeUTF8))
        self.spaceRadio.setText(QtGui.QApplication.translate("MainWindow", "Space", None, QtGui.QApplication.UnicodeUTF8))
        self.exteriorRadio.setText(QtGui.QApplication.translate("MainWindow", "Exterior", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("MainWindow", "Graphics", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("MainWindow", "Space:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("MainWindow", "Exterior:", None, QtGui.QApplication.UnicodeUTF8))
